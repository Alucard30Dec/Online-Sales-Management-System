...
Scenario coverage is designed and source-backed, while execution status and evidence are maintained separately in the final-results and metrics artifacts.
