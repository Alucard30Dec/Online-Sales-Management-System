...
Current final packaging note:

- The draft structure below was later normalized into the clean submission package `SV00123-ATU-A01/`.
- The canonical final top-level folders are:
  - `MainReport/`
  - `TestCases/`
  - `TestResults/`
  - `TestScript-Data/`
