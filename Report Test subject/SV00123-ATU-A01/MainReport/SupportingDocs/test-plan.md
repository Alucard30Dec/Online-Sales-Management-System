...
Automation framework implementation and evidence are now present in the submission package under `SV00123-ATU-A01/TestScript-Data/Automation/` and `SV00123-ATU-A01/TestResults/Evidence/`.
...
5. Required screenshots and execution evidence are captured and stored in `SV00123-ATU-A01/TestResults/Evidence/`.
